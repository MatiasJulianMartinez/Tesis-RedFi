// src/components/modals/boletas/ModalConfirmacionPlan.jsx
...
const ModalConfirmacionPlan = ({ usuarioId, nuevoPlan, onClose }) => {
  ...
  const mensajes = {
    premium: {
      ...
      icono: <IconStar size={48} className="text-green-500 mx-auto mb-4" />,
    },
    basico: {
      ...
      icono: (
        <IconAlertTriangle size={48} className="text-yellow-500 mx-auto mb-4" />
      ),
    },
  };
